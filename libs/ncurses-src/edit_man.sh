...
TERMINFO="/home/hmunoz-g/42-OuterCore/nibbler/libs/ncurses/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f "/home/hmunoz-g/42-OuterCore/nibbler/libs/ncurses-src/man_alias.sed" ; then
cat >>/home/hmunoz-g/42-OuterCore/nibbler/libs/ncurses-src/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/hmunoz-g/42-OuterCore/nibbler/libs/ncurses-src/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$inalias" |sed -f "/home/hmunoz-g/42-OuterCore/nibbler/libs/ncurses-src/man_alias.sed" | sort -u; test "$inalias" = "$nCurses" && echo curses`
	cf_target=`grep "^$cf_source" /home/hmunoz-g/42-OuterCore/nibbler/libs/ncurses-src/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f "/home/hmunoz-g/42-OuterCore/nibbler/libs/ncurses-src/man_alias.sed" \
		< "$i" | sed -f /home/hmunoz-g/42-OuterCore/nibbler/libs/ncurses-src/edit_man.sed >$TMP
